...
echo ""
printGreen "Сreate an Ethereum account and a keystore" & sleep 2
...
echo ""
printGreen "Docker update" & sleep 2
echo ""
sudo apt-get update
...
echo ""
printGreen "Wе сheck whether the folder has been created" & sleep 2
echo ""
